...
//				}
				...
				if (g==0){ // Primeira geraï¿½ï¿½o, ainda nï¿½o existe o arquivo
					lerArquivos.gerarCsvSolucao(numIndividuos, g,makespan_f, custo_f, tempoInicial, nivelDominancia,y);
					lerArquivos.gerarCsvSequenciaSolucao(numIndividuos, numMaquinas, numTarefas, g, makespan_f, custo_f, tempoInicial, nivelDominancia, seq_Pop_filhos,y);
				}else{ //Atualizaï¿½ï¿½o do Arquivo
					int auxSeqPop[][][] = lerArquivos.lerArquivoSolucoes(numIndividuos, numMaquinas, numTarefas,g,y);	
					int contArquivo = 0;				
					...
					lerArquivos.gerarCsvSolucao(numIndividuos, g, makespan_f, custo, tempoInicial, nivelDominancia,y);
					lerArquivos.gerarCsvSequenciaSolucao(numIndividuos, numMaquinas, numTarefas, g, makespan_f, custo, tempoInicial, nivelDominancia, seq_Pop_filhos,y);
				}
				//FIM DO ARQUIVO
				...
				if (g==500) {
					lerArquivos.gerarMelhorPiorFOBJ(g, auxMakespan, auxCusto, auxPiorCusto, auxPiorMakespan,y);
					lerArquivos.gerarCsvSequenciaSolucao(numIndividuos, numMaquinas, numTarefas, g, makespan, custo, tempoInicial, nivelDominancia, seq_pop_linha,y);
					lerArquivos.gerarCsvSolucaoResultados(numIndividuos, g, makespan, custo, tempoInicial, nivelDominancia,y);
				...
				if (g==1000) {
					lerArquivos.gerarMelhorPiorFOBJ(g, mMakespan, mCusto, piorCustoGeracao, piorMakespanGeracao,y);
					lerArquivos.gerarCsvSequenciaSolucao(numIndividuos, numMaquinas, numTarefas, g, makespan, custo, tempoInicial, nivelDominancia, seq_pop_linha,y);
					lerArquivos.gerarCsvSolucaoResultados(numIndividuos, g, makespan, custo, tempoInicial, nivelDominancia,y);
					piorMakespanGeracao = 0;
					piorCustoGeracao = 0;
